...
w = [0.0]*3
Angle = [0.0]*3
def DueData(inputdata,storage):   #新增的核心程序，对读取的数据进行划分，各自读到对应的数组里
